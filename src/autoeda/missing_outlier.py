"""
Diagnostics for missing values and outliers in tabular data.

This module provides utilities to summarize missing values
and detect potential outliers in numeric columns, with
interpretable risk levels and suggested actions for EDA.
"""
